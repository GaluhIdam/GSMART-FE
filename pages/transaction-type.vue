        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 bg-white">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <p class="page-heading d-flex text-dark fs-6 flex-column justify-content-center my-0 fw-bold">Transaction Type</p>
                    <!--end::Title-->
                </div>
                    ...
                    <div class="py-5">
                        <div class="table-responsive">
                            <table class="table table-row-bordered table-row-gray-200 gy-4">
                                ...
                                <tbody>
                                    <tr v-for="(transaction, transaction_index) in transaction_type.data" :key="transaction_index">
                                        <td class="text-center">{{ transaction_type.from + transaction_index }}</td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-sm btn-light" data-bs-toggle="modal" data-bs-target="#modal" @click="edit(transaction)">
                                                <i class="bi bi-pencil-square text-primary"></i>
                                            </button>
                                            <button class="btn btn-sm btn-light" v-on:click="remove(transaction.id)">
                                ...
                                <ul class="pagination">
                                    <li class="page-item">
                                        <button
                                            ...
                                            @click="transaction_type.prev_page_url && list(transaction_type.prev_page_url)"
                                        >
                                            Previous
                                        </button>
                                    </li>
                                    ...
                                    <li class="page-item">
                                        <button
                                            ...
                                            @click="transaction_type.next_page_url && list(transaction_type.next_page_url)"
                                        >
                                            Next
                                        </button>
                                    </li>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 v-if="modal_create" class="modal-title">Add Transaction Type</h3>
            ...
            Swal.fire({
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        this.$axios.delete("/api/transaction-type-delete/" + id).then((response) => {
                            toastr.success(response.data.message);
                            this.list();
                        });
                    }
