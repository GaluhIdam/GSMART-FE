<template>
  <div>
    ...
    >
      <!--begin::Logo-->
      <div
        class="app-sidebar-logo px-6 border-bottom-0"
          ...
          >
            ...
            <div class="menu-item">
              <NuxtLink class="menu-link" to="/my-prospect" active-class="active">
                ...
                <span class="menu-title" v-if="role == 'TPR' || role == 'TPC' || role == 'CBO' || role == 'Administrator'">All Prospect</span>
            ...
            <div class="menu-item">
              <NuxtLink class="menu-link" to="/my-salesplan" active-class="active">
                ...
                <span class="menu-title" v-if="role == 'TPR' || role == 'TPC' || role == 'CBO' || role == 'Administrator'">All Sales Plan</span>
            ...
            <div v-if="role == 'Administrator'">
              ...
              >
                ...
                <div class="menu-sub menu-sub-accordion" active-class="show">
                  <div class="menu-item">
                    <Nuxt-link
                      class="menu-link"
                      to="/customer"
