        ...
        <div class="card-body">
          <div class="row d-flex align-items-center">
            ...
            <div class="position-relative me-md-2">
              ...
              <!--end::Svg Icon-->
              <input type="text" class="form-control form-control-solid ps-10" initial="search" v-model="search"
                placeholder="Search" />
            </div>
            <!--end::Input group-->
          </div>
          ...
          <div class="modal-body">
            <form @submit.prevent="submit">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" v-model="p_ams.initial" :class="{
              ...
              <div class="form-group mb-3">
                ...
                <multiselect v-model="selectedUser" id="ajax" :custom-label="userLabel" track-by="id"
                  placeholder="Select User" open-direction="bottom" :options="users" :multiple="false"
                  :searchable="true" :loading="isLoading" :internal-search="false" :clear-on-select="false"
                  :close-on-select="true" :options-limit="300" :max-height="600" :show-no-results="false"
                  @search-change="findUser" @select="selectedUser">
                </multiselect>
