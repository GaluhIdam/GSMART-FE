              ...
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                <thead>
                  <tr class="fw-bold fs-6 text-gray-800">
                    ...
                    <th v-if="order == 'description' && by == 'asc'" @click="sort('description', 'desc')" class="text-center">Work Type <i class="fa-solid fa-sort-up" style="color: black"></i></th>
                    <th v-else-if="order == 'description' && by == 'desc'" @click="sort('id', 'desc')" class="text-center">Work Type <i class="fa-solid fa-sort-down" style="color: black"></i></th>
                    <th v-else @click="sort('description', 'asc')" class="text-center">Work Type <i class="fa-solid fa-sort"></i></th>
                ...
                <tbody>
                  <tr
                    v-for="(
                      p_maintenance, p_maintenance_index
                    ) in maintenance.data"
                    :key="p_maintenance_index"
                  >
                    <td class="text-center">
                      {{ maintenance.from + p_maintenance_index }}.
                    </td>
                    ...
                    <td class="d-flex justify-content-center">
                      ...
                      <button
                        ...
                        v-on:click="remove(p_maintenance.id)"
                      >
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-8 d-flex justify-content-end align-items-center">
                            <nav>
                                <ul class="pagination">
                                    <!-- Start pagination -->
                                    <li v-for="(link, link_index) in maintenance.links" :key="link_index" class="page-item" :class="{ disabled: !link.url, active: link.active }">
            ...
            <form @submit.prevent="submit">
              ...
              <div class="form-group mb-3">
                ...
                <input
                  type="text"
                  class="form-control"
                  v-model="p_maintenance.description"
                  :class="{
