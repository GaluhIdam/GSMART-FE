                ...
                <ul class="pagination">
                  <li class="page-item">
                    <button
                      ...
                      class="page-link"
                      :class="{
                        disabled: !prospect_type.prev_page_url,
                      }"
                      @click="
                        prospect_type.prev_page_url &&
                          list(prospect_type.prev_page_url)
                      "
                    >
                      Previous
                    </button>
                  ...
                  <li class="page-item">
                    <button
                      ...
                      class="page-link"
                      :class="{
                        disabled: !prospect_type.next_page_url,
                      }"
                      @click="
                        prospect_type.next_page_url &&
                          list(prospect_type.next_page_url)
                      "
                    >
                      Next
                    </button>
