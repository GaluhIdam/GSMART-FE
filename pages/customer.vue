              ...
              <div id="kt_docs_repeater_basic">
                ...
                <div class="form-group">
                  <div data-repeater-list="kt_docs_repeater_basic">
                    <div
                      data-repeater-item
                      v-for="(multiselect, index) in multiselectList"
                      :key="index"
                    >
                      <div class="form-group row mb-5">
                        ...
                        <div class="col-md-5 text-center">
                          ...
                          <multiselect
                            v-model="area_ams[index.area_id]"
...
export default {
  ...
  methods: {
    AddMoreMultiselect() {
      this.multiselectList.push('multiselect')
    },
    remove(index) {
