    ...
    <div class="container mb-10">
      <div class="card shadow-sm mt-5">
        <div class="card-header">
          <h3 class="card-title fw-bold">List of countrie</h3>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="modal-title">Add countrie</h3>
          ...
          <div class="py-5">
            <div class="table-responsive">
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                ...
                <tbody>
                  <tr
                    v-for="(countrie, countrie_index) in countries.data"
                    :key="countrie_index"
                  >
                    <td class="text-center">{{ countrie_index + 1 }}</td>
              ...
              >
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h3 class="modal-title">Edit countrie Type</h3>
    ...
    list(paginate) {
      ...
      this.$axios
        ...
        .then((response) => {
          ...
          this.current_page = this.countries.current_page
          Swal.close()
        })
