    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 bg-white">
      ...
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
          ...
          <li class="breadcrumb-item text-muted">Maintenances</li>
          <!--end::Item-->
        </ul>
        <!--end::Page title-->
      </div>
          ...
          <div class="py-5">
            <div class="table-responsive">
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                ...
                <tbody>
                  <tr v-for="(p_maintenance, p_maintenance_index) in maintenance.data" :key="p_maintenance_index">
                    <td class="text-center">{{ maintenance.from + p_maintenance_index }}</td>
                    <td class="text-center">{{ p_maintenance.name }}</td>
                    <td class="text-center">{{ p_maintenance.description }}</td>
                    ...
                    <td class="d-flex justify-content-center">
                      ...
                      <button class="btn btn-sm btn-light" data-bs-toggle="modal" data-bs-target="#modal"
                        @click="edit(p_maintenance)">
                        <i class="bi bi-pencil-square text-primary"></i>
                      </button>
                      <button class="btn btn-sm btn-light" v-on:click="remove(p_maintenance.id)">
                        <i class="bi bi-trash-fill text-primary"></i>
                      </button>
                    </td>
                  </tr>
                  <tr v-if="maintenance.data.length < 1">
                    <td colspan="8">
                ...
                <ul class="pagination">
                  <li class="page-item">
                    <button type="button" class="page-link" :class="{
                      disabled: !maintenance.prev_page_url,
                    }" @click="maintenance.prev_page_url && list(maintenance.prev_page_url)">
                      Previous
                    </button>
                  </li>
                  ...
                  <li class="page-item">
                    <button type="button" class="page-link" :class="{
                      disabled: !maintenance.next_page_url,
                    }" @click="maintenance.next_page_url && list(maintenance.next_page_url)">
                      Next
                    </button>
                  </li>
                </ul>
          ...
          <div class="modal-body">
            <form @submit.prevent="submit">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" v-model="p_maintenance.name" :class="{
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" v-model="p_maintenance.description" :class="{
...
export default {
  ...
  methods: {
    list(paginate) {
      this.loading();
      paginate = paginate || `/api/maintenance`;
      this.$axios
        .get(paginate, {
          params: {
            search: this.search,
        ...
        .then((response) => {
          ...
          this.current_page = this.maintenance.current_page;
          Swal.close();
        })
    ...
    directPage: debounce(function () {
      if (this.current_page < 1) {
        this.current_page = 1;
      } else if (this.current_page > this.maintenance.last_page) {
        this.current_page = this.maintenance.last_page;
      }
      let url = new URL(this.maintenance.first_page_url);
    ...
    create() {
      ...
      this.$axios
        .post("/api/maintenance-create", {
          name: this.p_maintenance.name,
          description: this.p_maintenance.description,
    ...
    edit(p_maintenance) {
      ...
      this.p_maintenance.id = p_maintenance.id;
      this.p_maintenance.name = p_maintenance.name;
      this.p_maintenance.description = p_maintenance.description;
    ...
    update() {
      ...
      this.$axios
        .put("/api/maintenance-update/" + this.p_maintenance.id, {
          name: this.p_maintenance.name,
          description: this.p_maintenance.description,
      ...
      Swal.fire({
        ...
        .then((result) => {
          if (result.isConfirmed) {
            this.$axios.delete("/api/maintenance-delete/" + id).then((response) => {
              toastr.success(response.data.message);
              this.list();
            });
          }
    ...
    clearForm() {
      this.p_maintenance.id = null;
      this.p_maintenance.name = null;
      this.p_maintenance.description = null;
