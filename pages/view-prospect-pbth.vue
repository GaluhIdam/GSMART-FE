<template>
  <div>
    ...
    <div class="container mb-10">
        ...
        <div class="mb-10" v-if="inputOptionsValue == 'Input Convidence Level'">
          <div class="card shadow-sm mt-5">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-5">
                  <input type="text" class="form-control form-control-solid" name="convidence" v-model="convidence">
                </div>
                <div class="col-md-6">
                  <span class="fs-1 me-3">%</span>
                  <button @click="calculateSalesPlan(convidence)" class="btn btn-primary" :disabled="convidence > 100 || convidence < 0">Calculate</button>
                  <button class="btn btn-primary" @click="createSalesPlan()" :disabled="convidence > 100 || convidence < 0">Save</button>
                </div>
              ...
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                ...
                <tbody>
                  <tr v-for="(data, pbth_index) in pbth" :key="pbth_index">
                    ...
                    <td class="text-center" v-if="data.planFH">{{ data.planFH }} %</td>
        ...
        <div class="mb-10" v-else-if="inputOptionsValue == 'Input Convidence Flight Hour'">
          <div class="card shadow-sm mt-5">
            <div class="card-header">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <button @click="calculateSalesPlanFH(convidence)" class="btn btn-primary">Calculate</button>
              ...
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                ...
                <tbody>
                  <tr v-for="(data, pbth_index) in pbth" :key="pbth_index">
                    ...
                    <td class="text-center" v-if="data.planFH">{{ data.planFH }}</td>
                    <td class="text-center" v-else>0</td>
                    <td class="text-center" style="color: #50CD89" v-if="data.value">
                      USD {{ formatNumber(data.value) }}</td>
                  ...
                  <tr>
                    ...
                    <td class="text-center fs-3 fw-bold" style="color: #50CD89">
                      USD {{ formatNumber(total_sales_plan) }}
                    </td>
                  </tr>
                </tbody>
              </table>
