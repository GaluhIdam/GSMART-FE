                ...
                <ul class="pagination">
                  <li class="page-item">
                    <button
                      ...
                      class="page-link"
                      :class="{
                        disabled: !role.prev_page_url,
                      }"
                      @click="role.prev_page_url && list(role.prev_page_url)"
                    >
                      Previous
                    </button>
                  </li>
                  ...
                  <li class="page-item">
                    <button
                      ...
                      class="page-link"
                      :class="{
                        disabled: !role.next_page_url,
                      }"
                      @click="role.next_page_url && list(role.next_page_url)"
                    >
                      Next
                    </button>
                  </li>
